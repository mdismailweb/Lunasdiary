    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ fontSize: '3rem', marginBottom: '1rem', filter: 'drop-shadow(0 0 20px rgba(167,139,250,0.6))' }}>🔒</div>

                <h2 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '0.4rem' }}>
                    {mode === 'set' ? 'Set Vault Password' : 'Vault Locked'}
                </h2>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <input type="password" placeholder={mode === 'set' ? 'New password' : 'Password'}
